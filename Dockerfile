...
# Debugging Notes:
#
#   docker run -it --rm live_view_example_usage /bin/ash
...
# Copy over the mix.exs and mix.lock files to load the depenencies. If those
...
COPY --from=build --chown=nobody:nobody /app/_build/prod/rel/live_view_example_usage ./
